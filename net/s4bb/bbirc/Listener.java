...
public class Listener extends Thread {
	...
	public void run() {
		...
		String tmpnick = uihandler.nick.equals("") ? jmIrc.NAME + "_nick" : uihandler.nick;
		String tmpuser = username.equals("") ? tmpnick : username;
		String tmpreal = realname.equals("") ? jmIrc.NAME + " user" : realname;
					...
					if (cmdline[2].indexOf('\001') != -1) {
						...
						while((ctcpidx1 = cmdline[2].indexOf('\001', ctcpidx2+1)) != -1) {
							...
							if (ctcpcmd.equals("ACTION")) {
								...
								jmIrc.writeLine("NOTICE " + fromnick + " :\001VERSION " + jmIrc.NAME + " " + jmIrc.VERSION + " on " + platf + "\001");
							}
