...
import net.s4bb.customization.About;
import net.s4bb.customization.BES_NonBES_Requester;

public class BBirc extends MIDlet implements CommandListener {
	...
	private Command cmd_connect, cmd_profiles, cmd_advanced, cmd_interface, cmd_http, cmd_about, cmd_exit;
  ...
  public final String S_DEFAULT = "Default";
  private StringItem currentprofile = new StringItem("Current Profile:", S_DEFAULT);
	...
	public BBirc() {
      ...
      try {
        NAME = this.getAppProperty("MIDlet-Name");
      } catch (Exception e) {
      }
        ...
        cmd_about = new Command("About", Command.OK, 6);
		cmd_exit = new Command("Exit", Command.EXIT, 7);
		...
		mainform = new Form("BBirc");
		mainform.append("BBirc " + VERSION + "\n");
		mainform.append("By S4BB Ltd.");
    mainform.append(currentprofile); //by k
    ...
    new BES_NonBES_Requester(this).initUserRequest();
	}
	...
	public void commandAction(Command cmd, Displayable disp) {
		if (cmd == cmd_connect) {
          ...
          //uihandler.setDisplay(getAbout());
          Display.getDisplay( this ).setCurrent(net.s4bb.customization.About.getAbout(this));
        }
        ...
        currentprofile.setText(db.getProfiles()[db.profileidx]); //by k
				display.setCurrent(mainform);
			}
			...
			if (cmd == cmd_profiles) {
				...
				tf_username = new TextField("Username", db.username, 8, TextField.ANY);
	...
	public void destroyApp(boolean unconditional) throws MIDletStateChangeException {
		if (irc != null && irc.isConnected()) {
			...
			BBirc.disconnect("QUIT: " + BBirc.NAME + " destroyed by the OS");
		}
		if (db.usehttp) {
